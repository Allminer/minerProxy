...
Web界面操作，简单易用，一键安装，小白可以轻松上手。开机自启动，进程守护运行，自动调整连接数限制。  支持/BTC/ETH/ETC/BCH/LTC/RVN/ERGO/CFX/KAS/IRON/CKB/DASH/KDA/ZEC/ZEN/NEXA/ETC+ZIL/ZEPH/KLS/space  程序持续更新中
